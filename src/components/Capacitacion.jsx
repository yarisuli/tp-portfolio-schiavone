  ...
  return (
    <section className="capacitacion-section" id="capacitacion">
      ...
      <div className="capacitacion-content">
        <h2 className="capacitacion-title">Capacitación</h2>
        <p className="capacitacion-text">
          ...
          <span className="capacitacion-text-normal">Seminario de gestión de redes e identidad</span><br />
          <span className="capacitacion-text-extra-light">Academia Scissors (2024)</span><br />
          <span className="capacitacion-text-normal">Seminario de tricología y colorimetría</span><br />
          <span className="capacitacion-text-extra-light">Academia Scissors (2024)</span><br />
          <span className="capacitacion-text-normal">Seminario de tricología y colorimetría</span><br />
          ...
          <span className="capacitacion-text-normal">Curso de barbería para caballeros</span>
        </p>
      </div>
    </section>
  )
